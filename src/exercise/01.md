...
Take the last extra credit a step further and see if you can figure out how to
implement an
[`AbortController`](https://developer.mozilla.org/en-US/docs/Web/API/AbortController/abort)
for the request so the request is actually canceled if the component's
unmounted.

NOTE: The call to update the user is not actually using `fetch` (yet) so this
won't actually work, but it should be a fun exercise anyway.

## 🦉 Elaboration and Feedback

<div>
<span>After the instruction, if you want to remember what you've just learned, then </span>
<a rel="noopener noreferrer" target="_blank" href="https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=01%3A%20Context%20Controller&em=">
