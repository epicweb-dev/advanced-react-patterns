...
their own `onClick` handler! Try doing that by updating the `Usage` component to
this:
...
Let's try that. Update the `Usage` component to this:
...
<a rel="noopener noreferrer" target="_blank" href="https://ws.kcd.im/?ws=Advanced%20React%20Patterns%20%F0%9F%A4%AF&e=04%3A%2004%20-%20Prop%20Collections%20and%20Getters&em=">
